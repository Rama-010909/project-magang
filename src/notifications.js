    ...
    return onMessage(messaging, payload => {
      ...
      if (Notification.permission === 'granted') {
        showAssetNotification({
          type: ['device_trouble', 'internet_trouble', 'network_trouble', 'trouble', 'offline', 'down', 'error', 'gangguan', 'unreachable'].includes(String(d.status || '').toLowerCase()) ? 'trouble' : 'safe',
          asset: {
